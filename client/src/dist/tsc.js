...
var score = 0;
var goals = 0;
var Monad = function Monad(z, ID) {
    if (ID === void 0) { ID = 'anonymous'; }
    var _this = this;
    this.id = ID;
    this.x = z;
    Monad.prototype.bnd = function (func, x) {
        var args = [];
        for (var _i = 2; _i < arguments.length; _i++) {
            args[_i - 2] = arguments[_i];
        }
        return func.apply(void 0, [_this.x].concat(args));
    };
    Monad.prototype.ret = function (a) {
        console.log('>>>>>>>>>>>>>>>>>>>>>>>>>>_this and _this.id ', _this, _this.id);
...
var MonadSet = function MonadSet(set, ID) {
    ...
    this.add = function (a) {
        s.add(a);
        return new MonadSet(set, _this.id);
    };
    this.delete = function (a) {
        s.delete(a);
        return new MonadSet(s, _this.id);
    };
    this.clear = function () {
        s.clear;
        return new MonadSet(s, _this.id);
...
var reduce = function reduce(x) {
    var ar = x.slice();
    var ar2 = ar.reduce(function (a, b) { return (a + ', ' + b); });
    return ret(ar2);
};
