...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var PFPress$ = sources.DOM.select('input#PF_1').events('keypress');

	  var PFAction$ = PFPress$.map(function (e) {
	    var v = e.target.value;
	    if (e.keyCode == 13) {
	  ...
	  function primeFib(x) {
	    ...
	    var l = fibs.length - 3;
	    var primes = primesMonad.run([Math.round(Math.sqrt([fibs[fibs.length - 1]])), 6, 0, [2, 3, 5]]).a;
	    fibs.map(function (f) {
	      ar = [];
