	...
	function main(sources) {
	  ...
	  mMitterPrime5.bnd(function (arr) {
	    ...
	    if (x > v[0][v[0].length - 1]) {
	      ...
	      console.log('<><><><><><><><><><><><><><><><><><><><><><><><><><><><><>arr[0], O.mMpf.x[0], primeFibs ', arr[0], O.mMpf.x[0], primeFibs);
	  ...
	  function pFib(fibs, primes) {
	    console.log('<><><>>< JUST ENTERED pFib %%%%%% fibs, primes ', fibs, primes);
	    var ar = [];
	    var ar2 = [];
	    fibs.map(function (f) {
	      ar = [];
