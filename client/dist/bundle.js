...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var observableFib = (0, _dom.h)('pre', '  function fibFunc(n) {\n    var a = observable(1);\n    var ar = [0,1];\n    var k = 0;\n    a.observe(function(b, c) {\n      k+=1;\n      ar.push(c);\n      if (k < n) {\n          a.set(b + c);\n      }\n      document.getElementById(newFib).innerHTML = ar;\n    });\n    a.set(1);\n    a.set(2);\n  }  ');
