	...
	function main(sources) {
	  ...
	  var messages2$ = sources.WS.map(function (e) {
	    if (O.LOCK.x) {
	      var v2 = e.data.split(',');
	      var members = v2.slice(3);
	      document.getElementById('request2').innerHTML = 'The current online members of ' + O.pMgroup.x + ' are:';
	      document.getElementById('request3').innerHTML = members;
	      LOCK.ret(false);
	    }
	  });
