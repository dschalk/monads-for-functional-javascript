	...
	*/
	...
	function main(sources) {
	  ...
	  var spread1PressAction$ = spread1Press$.map(function (e) {
	    ...
	    var v = e.target.value;
	    if (e.keyCode == 13) {
	      mMcount.ret(e.target.value).bnd(function () {
	        return calculate();
	      });
	    }
	  });
	  ...
	  var spread2PressAction$ = spread2Press$.map(function (e) {
	    ...
	    var v = e.target.value;
	    if (e.keyCode == 13) {
	      mMcount2.ret(e.target.value).bnd(function () {
	        return calculate();
	      });
	    }
	  });
	  ...
	  var calculate = function calculate() {
	    var a = O.mMcount.x;
	    var b = O.mMcount2.x;
	    var c = [a + ' + ' + b + ' = ' + (a * 1 + b * 1), a + ' - ' + b + ' = ' + (a - b), a + ' * ' + b + ' = ' + a * b, a + ' / ' + b + ' = ' + a / b];
	    mMspreadsheet.ret(c);
	  };

	  var spread3Press$ = sources.DOM.select('#spread3').events('keypress');

	  var spread3PressAction$ = spread3Press$.map(function (e) {
	  ...
	  var spread4Press$ = sources.DOM.select('#spread4').events('keypress');

	  var spread4PressAction$ = spread4Press$.map(function (e) {
