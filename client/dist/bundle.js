...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var primeFib$ = fibKeyPress5$.map(function (e) {
	    ...
	    if (e.keyCode == 13) {
	      if (e.target.value > fibsMonad.a.length) {
	        var y = fibsMonad.run([fibsMonad.s[1], fibsMonad.s[0] + fibsMonad.s[1], e.target.value, fibsMonad.a]);
	        result = y.bnd(tr);
	      } else {
	        var r1 = fibsMonad.a.slice().filter(function (v) {
	          return v <= e.target.value;
	        });
	        var r2 = r1[r1.length - 1];
	        var r3 = r1[r1.length - 2];
	        result = fibsMonad.run([r2 + r3, r2 + r3 + r2, e.target.value, r1]).bnd(tr);
	      }
	      document.getElementById('PF_9').innerHTML = result[0];
	      document.getElementById('PF_22').innerHTML = result[1];
	      document.getElementById('primeFibs').innerHTML = result[2];
