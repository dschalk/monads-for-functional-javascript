	        ...
	        return mMZ3.bnd(function (b) {
	          return mMtemp.ret(b).bnd(innerHTML, " + " + b + " * x ", 'quad6', mMtemp).bnd(function (b) {
	            return mMZ3.bnd(function (c) {
	              var x = qS1(a, b, c);
	              var y = qS2(a, b, c);
	              document.getElementById('quad5').innerHTML = 'The results are: x = ' + x + ' and x =';
	              document.getElementById('quad6').innerHTML = y;
	              solve();
	            });
	          });
