	  ...
	  var primeFib$ = fibKeyPress5$.map(function (e) {
	    if (e.keyCode == 13) {
	      ...
	      var res = fibsMonad.bnd(function (fibsState) {
	        return fibsMonad.bnd(transformer, primesMonad).bnd(function (primesState) {
