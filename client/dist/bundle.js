...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var primeFib = (0, _dom.h)('pre', '  var primesMonad = new MonadState(\'primesMonad\', [3, 2, \'primesMonad\', [2]], [2],  primes_state) \n\n  function primes_state(x) {\n    var v = x.slice();\n    var R;\n      while (v[1] <= v[0]) {\n        if (check()) {\n          v[3].push(v[1]);\n        }\n        v[1]+=2;\n      }\n      function check () {\n        var R = false;\n        v[3].map(e => {\n          if ((v[1] % e) == 0) {\n            return;\n          }\n          if (e ==  v[3][v[3].length - 1]) {\n             R = true;\n          }\n        })\n        return R;\n      }\n    return v;\n  }  ');
