...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var primesMonad = (0, _dom.h)('pre', '  var primesMonad = new MonadState(\'primesMonad\', [2, 3, \'primesMonad\', [2]], [2],  primes_state)  \n\n  function primes_state(x) {\n    var v = x.slice();\n    var ar = [];\n    var R;\n    var a = v[0];\n    var b = v[1];\n    var c = v[2];\n    var d = v[3];\n      while (b <= a) {\n        if (check(b,d)) {\n          d.push(b);\n          b = b + 2;\n        }\n        else {b = b + 2};\n      }\n    return [a,b,c,d];\n\n\n  function check (n, x) {\n    var ar = x.slice();\n    var ar2 = [];\n    var R = false;\n    ar.map(e => {\n      if ((n % e) == 0) {\n        return;\n      }\n      ar2.push(e);\n      if (ar2.length == ar.length) {\n         R = true;\n      }\n    })\n    return R;\n  }  ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var fibKeyPressAction5$ = fibKeyPress5$.map(function (e) {
	    ...
	    if (e.keyCode == 13) {
	      var fibs = runFib(e.target.value);
	      var fibs2 = fibs.filter(function (v) {
	        return v <= Math.round(Math.sqrt(fibs[fibs.length - 1]));
	      });
	      var c = fibs[fibs2.length];
	      console.log('>>>>>>>>>>>> fibs2, c ', fibs2, c);
	      var primes = runPrime(c);
