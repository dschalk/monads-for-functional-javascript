...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var primeFib3 = /* harmony import */ __WEBPACK_IMPORTED_MODULE_0__motorcycle_dom__["h"]('pre', `          mM$fib.stream.addListener({
	    next: v => {
	      if (v[2] > 1) {mM$fib.ret([v[1], v[0] + v[1], v[2] -1])}
	      else {
	        console.log(v[0]);
