	  ...
	  var messages2$ = sources.WS.map(function (e) {
	    if (!O.LOCKED.x) {
	      ...
	      ret(v2.slice(3)).bnd(function (v) {
	        return mMtemp.bnd(html, 'request2', 'The current online members of ' + O.pMgroup.x + ' are:').bnd(function () {
	          return mMtemp.bnd(html, 'request3', v).bnd(function () {
