	...
	function main(sources) {
	  ...
	  mMitterPrime5.bnd(function (arr) {
	    ...
	    if (x > v[0][v[0].length - 1]) {
	      ...
	      var primeF = O.mMpf.x[0];
	      var primeFibs = primeF.filter(function (g) {
	        return g < arr[0] + 1;
	      });
	      document.getElementById('PF_8').innerHTML = "Prime Fibonacci Numbers:";
	      document.getElementById('primeFibs').innerHTML = primeFibs;
	  ...
	  mMitterFib5.bnd(function (x) {
	    ...
	    var a = ar[ar.length - 1];
	    if (x > a) {
	      var b = ar[ar.length - 2];
	      mM$fib5.ret([b, a, x]);
	    } else {
