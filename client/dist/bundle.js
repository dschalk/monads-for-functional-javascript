...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var seed6 = /* harmony import */ __WEBPACK_IMPORTED_MODULE_0__motorcycle_dom__["h"]('pre', ` 
	             `);

	/* harmony default export */ exports["default"] = { monad, monadStr, monadIt, fib, driver, messages, next, Monad$, updateCalc, arrayFuncs, travel, nums, cleanup, ret, C42, taskStream, newTask, process, mM$task, addString, colorClick, edit, testZ, quad, mdem1, runTest, todoStream, gameStream, inc, ret_add_cube, primes, seed }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  const fibClick$ = sources.DOM.select('button#fibButton').events('click');
	  ...
	  */
	      ...
	      for (let i in v[0]) {
	        ...
	        if (i == v[0].length - 1) {
	          ...
	          if (v[0][v[0].length - 1] < v[2]) {
	            console.log('Inside the if statement in mMprime3 listener. v[0], v[2],' + 'and v[0][v[0].length - 1] < v[2] are:', v[0], v[2], v[0][v[0].length - 1] < v[2]);
	  ...
	  const primeClick$ = sources.DOM.select('#prime').events('click');
	  const primeClickAction$ = primeClick$.map(() => {
	    mMitterPrime.release();
	  });
	  ...
	  const primeKeyPress$ = sources.DOM.select('input#prime333').events('keydown');
	  ...
	  const fibClick3$ = sources.DOM.select('button#fibButton').events('click');
	    ...
	    next: v => {
	      if (v[2] > 1) {
	        ...
	        mMitterPrimeKeyPress2.bnd(x => {
	          ...
	          console.log('>>>>>>>>>>>>>>>In mMitterPrimeKeyPress2.bnd ...   top and x are: ', top, x), console.log(x[0] > top);
	          if (x[0] > top) {
