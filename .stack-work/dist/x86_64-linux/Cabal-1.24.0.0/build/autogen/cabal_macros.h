...
/* package JS-monads-stable-0.7.0.0 */
#define VERSION_JS_monads_stable "0.7.0.0"
#define MIN_VERSION_JS_monads_stable(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  7 || \
...
#define CURRENT_COMPONENT_ID "JS-monads-stable-0.7.0.0"

#define CURRENT_PACKAGE_KEY "JS-monads-stable-0.7.0.0"
