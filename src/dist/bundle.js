	...
	*/
	...
	function main(sources) {
	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    mMtemp.ret(e.data.split(',')[0]).bnd(next, 'CA#$42', mMZ10).bnd(next, 'CD#$42', mMZ13).bnd(next, 'CE#$42', mMZ14).bnd(next, 'EE#$42', mMZ15).bnd(next, 'TG#$41', mMZ16).bnd(next, 'DD#$42', mMZ17).bnd(next, 'NN#$42', mMZ18).bnd(next, 'GG#$42', mMZ19);
	  });
	  ...
	  function testComments(data) {
	    ...
	    try {
	      for (var _iterator2 = arr[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	        ...
	        mM26.bnd(push, (0, _dom.h)('br'), 'mM26');
	      }
	    } catch (err) {
