...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (_primes$variations$Mo = { primes: primes, variations: variations, MonadEmitter: MonadEmitter, clicks: clicks, bNode: bNode, styl: styl, MonadState2: MonadState2, gameMonad: gameMonad, cycle: cycle, monad: monad, hardWay: hardWay, hardWay2: hardWay2, async1: async1, async2: async2, execP: execP, workerD$: workerD$, fact_workerC: fact_workerC, fact2_workerD: fact2_workerD, primes_state: primes_state, workerB_Driver: workerB_Driver, workerC: workerC, worker$: worker$, errorDemo: errorDemo, monadEr: monadEr, backAction: backAction, tests: tests, mMZ10: mMZ10, test3: test3 }, _defineProperty(_primes$variations$Mo, 'monad', monad), _defineProperty(_primes$variations$Mo, 'equals', equals), _defineProperty(_primes$variations$Mo, 'fmap', fmap), _defineProperty(_primes$variations$Mo, 'opM', opM), _defineProperty(_primes$variations$Mo, 'e2', e2), _defineProperty(_primes$variations$Mo, 'e2x', e2x), _defineProperty(_primes$variations$Mo, 'e3', e3), _defineProperty(_primes$variations$Mo, 'e4', e4), _defineProperty(_primes$variations$Mo, 'e4x', e4x), _defineProperty(_primes$variations$Mo, 'e6', e6), _defineProperty(_primes$variations$Mo, 'e6x', e6x), _defineProperty(_primes$variations$Mo, 'driver', driver), _defineProperty(_primes$variations$Mo, 'messages', messages), _defineProperty(_primes$variations$Mo, 'monadIt', monadIt), _defineProperty(_primes$variations$Mo, 'MonadSet', MonadSet), _defineProperty(_primes$variations$Mo, 'updateCalc', updateCalc), _defineProperty(_primes$variations$Mo, 'arrayFuncs', arrayFuncs), _defineProperty(_primes$variations$Mo, 'nums', nums), _defineProperty(_primes$variations$Mo, 'cleanup', cleanup), _defineProperty(_primes$variations$Mo, 'ret', ret), _defineProperty(_primes$variations$Mo, 'C42', C42), _defineProperty(_primes$variations$Mo, 'newTask', newTask), _defineProperty(_primes$variations$Mo, 'process', process), _defineProperty(_primes$variations$Mo, 'mM$task', mM$task), _defineProperty(_primes$variations$Mo, 'colorClick', colorClick), _defineProperty(_primes$variations$Mo, 'edit', edit), _defineProperty(_primes$variations$Mo, 'testZ', testZ), _defineProperty(_primes$variations$Mo, 'quad', quad), _defineProperty(_primes$variations$Mo, 'runTest', runTest), _defineProperty(_primes$variations$Mo, 'todoStream', todoStream), _defineProperty(_primes$variations$Mo, 'inc', inc), _defineProperty(_primes$variations$Mo, 'seed', seed), _defineProperty(_primes$variations$Mo, 'add', add), _defineProperty(_primes$variations$Mo, 'MonadState', MonadState), _defineProperty(_primes$variations$Mo, 'primesMonad', primesMonad), _defineProperty(_primes$variations$Mo, 'fibsMonad', fibsMonad), _defineProperty(_primes$variations$Mo, 'primeFibInterface', primeFibInterface), _defineProperty(_primes$variations$Mo, 'tr3', tr3), _defineProperty(_primes$variations$Mo, 'fpTransformer', fpTransformer), _defineProperty(_primes$variations$Mo, 'factorsMonad', factorsMonad), _defineProperty(_primes$variations$Mo, 'factorsInput', factorsInput), _defineProperty(_primes$variations$Mo, 'promise', promise), _defineProperty(_primes$variations$Mo, 'promiseSnippet', promiseSnippet), _defineProperty(_primes$variations$Mo, 'timeout', timeout), _defineProperty(_primes$variations$Mo, 'timeoutSnippet', timeoutSnippet), _defineProperty(_primes$variations$Mo, 'examples', examples), _defineProperty(_primes$variations$Mo, 'examples2', examples2), _primes$variations$Mo);
