	...
	*/
	...
	var Monad = function Monad() {
	  ...
	  this.bnd = function (func) {
	    ...
	    var m = func.apply(undefined, [_this.x].concat(args));
	...
	function ret2(v) {
	  var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'ret2';
	...
	function main(sources) {
	    ...
	    function updateCalc(ar, op) {
	        ...
	        if (result == 20) {
	            ...
	            pMnums.bnd(push, result).bnd(mMtemp3.ret).bnd(pMnums.ret).bnd(function (v) {
	                travMonad.run([v, pMscore.x, pMgoals.x]);
