	  ...
	  var messages$ = sources.WS.map(function (e) {
	    ...
	    mMtem.ret(e.data.split(',')).bnd(function (v) {
	      ...
	      mMZ17.bnd(function () {
	        ...
	        console.log('In mMZ17. typeof str is', typeof str === 'undefined' ? 'undefined' : _typeof(str));
	        taskMonad.run2(str);
	      });
	      mMZ18.bnd(function () {
