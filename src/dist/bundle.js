...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var e2x = (0, _dom.h)('pre', '   Output: From m: The values m\'s and c\'s x attributes are 0 and 27 respectively.  ');
	...
	var e4x = (0, _dom.h)('pre', '  Output: From m: The values m\'s and c\'s x attributes are 27 and 27 respectively.  ');
	...
	function main(sources) {
	    ...
	    var messages$ = sources.WS.map(function (e) {
	        mMtem.ret(e.data.split(',')).bnd(function (v) {
	            ...
	            mMZ11.bnd(function () {
	                return socket.send('CG#$42,' + get(pMgroup) + ',' + get(pMname) + ',' + get(score) + ',' + get(goals) + 'l');
	            });
	            mMZ12.bnd(function () {
	    ...
	    function updateCalc(ar, op) {
	        ...
	        if (result == 20) {
	            ...
	            mMnums.bnd(push, result).bnd(mMnums.ret).bnd(function (x) {
	                return updateElms(test2(get(mMstyle), x), x);
	            });
	            mM8.ret(0);
	            mM3.ret([]);
	        }
	    ...
	    function score2(scor) {
	        ...
	        if (scor != 25) {
	            ...
	            playerMonad.run([get(pMgoals), get(pMgoals.bnd(add, 1))]).bnd(function (s) {
