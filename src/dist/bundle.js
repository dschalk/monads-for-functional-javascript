...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	  ...
	  var chboxAction$ = chbox$.map(function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (_sco$calculations$pro = { sco: sco, calculations: calculations, prototypeAdditions: prototypeAdditions, styl: styl, num_op: num_op, fetch: fetch, gameMonad_2: gameMonad_2, newRoll: newRoll, primes3: primes3, primes2: primes2, primes: primes, variations: variations, MonadEmitter: MonadEmitter, clicks: clicks, bNode: bNode, MonadState2: MonadState2, gameMonad: gameMonad, cycle: cycle, monad: monad, hardWay: hardWay, hardWay2: hardWay2, async1: async1, async2: async2, execP: execP, workerD$: workerD$, fact_workerC: fact_workerC, fact2_workerD: fact2_workerD, primes_state: primes_state, workerB_Driver: workerB_Driver, workerC: workerC, worker$: worker$, errorDemo: errorDemo, monadEr: monadEr, backAction: backAction, tests: tests, mMZ10: mMZ10, test3: test3 }, _defineProperty(_sco$calculations$pro, 'monad', monad), _defineProperty(_sco$calculations$pro, 'equals', equals), _defineProperty(_sco$calculations$pro, 'fmap', fmap), _defineProperty(_sco$calculations$pro, 'opM', opM), _defineProperty(_sco$calculations$pro, 'e2', e2), _defineProperty(_sco$calculations$pro, 'e2x', e2x), _defineProperty(_sco$calculations$pro, 'e3', e3), _defineProperty(_sco$calculations$pro, 'e4', e4), _defineProperty(_sco$calculations$pro, 'e4x', e4x), _defineProperty(_sco$calculations$pro, 'e6', e6), _defineProperty(_sco$calculations$pro, 'e6x', e6x), _defineProperty(_sco$calculations$pro, 'driver', driver), _defineProperty(_sco$calculations$pro, 'messages', messages), _defineProperty(_sco$calculations$pro, 'monadIt', monadIt), _defineProperty(_sco$calculations$pro, 'MonadSet', MonadSet), _defineProperty(_sco$calculations$pro, 'updateCalc', updateCalc), _defineProperty(_sco$calculations$pro, 'arrayFuncs', arrayFuncs), _defineProperty(_sco$calculations$pro, 'nums', nums), _defineProperty(_sco$calculations$pro, 'cleanup', cleanup), _defineProperty(_sco$calculations$pro, 'ret', ret), _defineProperty(_sco$calculations$pro, 'C42', C42), _defineProperty(_sco$calculations$pro, 'newTask', newTask), _defineProperty(_sco$calculations$pro, 'process', process), _defineProperty(_sco$calculations$pro, 'mM$task', mM$task), _defineProperty(_sco$calculations$pro, 'colorClick', colorClick), _defineProperty(_sco$calculations$pro, 'edit', edit), _defineProperty(_sco$calculations$pro, 'testZ', testZ), _defineProperty(_sco$calculations$pro, 'quad', quad), _defineProperty(_sco$calculations$pro, 'runTest', runTest), _defineProperty(_sco$calculations$pro, 'todoStream', todoStream), _defineProperty(_sco$calculations$pro, 'inc', inc), _defineProperty(_sco$calculations$pro, 'seed', seed), _defineProperty(_sco$calculations$pro, 'add', add), _defineProperty(_sco$calculations$pro, 'MonadState', MonadState), _defineProperty(_sco$calculations$pro, 'primesMonad', primesMonad), _defineProperty(_sco$calculations$pro, 'fibsMonad', fibsMonad), _defineProperty(_sco$calculations$pro, 'primeFibInterface', primeFibInterface), _defineProperty(_sco$calculations$pro, 'tr3', tr3), _defineProperty(_sco$calculations$pro, 'fpTransformer', fpTransformer), _defineProperty(_sco$calculations$pro, 'factorsMonad', factorsMonad), _defineProperty(_sco$calculations$pro, 'factorsInput', factorsInput), _defineProperty(_sco$calculations$pro, 'promise', promise), _defineProperty(_sco$calculations$pro, 'promiseSnippet', promiseSnippet), _defineProperty(_sco$calculations$pro, 'timeout', timeout), _defineProperty(_sco$calculations$pro, 'timeoutSnippet', timeoutSnippet), _defineProperty(_sco$calculations$pro, 'examples', examples), _defineProperty(_sco$calculations$pro, 'examples2', examples2), _sco$calculations$pro);
