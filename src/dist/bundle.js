...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	    ...
	    var numClickAction$ = numClick$.map(function (e) {
	        ...
	        mMtemp.ret(pMnums.bnd(spliceM, e.target.id, 1).x).bnd(test3).bnd(pMstyle.ret);
	    ...
	    */
	    ...
	    var backAction$ = backClick$.map(function () {
	        if (pMindex.x > 1) {
	            var a = travMonad.a[travMonad.a.length + 1 - pMindex.x];
	    ...
	    var forwardAction$ = forwardClick$.map(function () {
	        if (pMindex.x < travMonad.a.length.x) {
	            var a = travMonad.a[travMonad.a.length - pMindex.x - 1];
