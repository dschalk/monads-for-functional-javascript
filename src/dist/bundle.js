...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = (_comments0$comments1$ = { comments0: comments0, comments1: comments1, comments2: comments2, comments3: comments3, comments4: comments4, comments5: comments5, comments6: comments6, todo1: todo1, todo2: todo2, sco: sco, calculations: calculations, prototypeAdditions: prototypeAdditions, styl: styl, num_op: num_op, fetch: fetch, gameMonad_2: gameMonad_2, newRoll: newRoll, primes3: primes3, primes2: primes2, primes: primes, variations: variations, variations2: variations2, MonadEmitter: MonadEmitter, clicks: clicks, bNode: bNode, MonadState2: MonadState2, gameMonad: gameMonad, cycle: cycle, monad: monad, hardWay: hardWay, hardWay2: hardWay2, async1: async1, async2: async2, execP: execP, workerD$: workerD$, fact_workerC: fact_workerC, fact2_workerD: fact2_workerD, primes_state: primes_state, workerB_Driver: workerB_Driver, workerC: workerC, worker$: worker$, errorDemo: errorDemo, monadEr: monadEr, backAction: backAction, tests: tests, mMZ10: mMZ10, test3: test3 }, _defineProperty(_comments0$comments1$, 'monad', monad), _defineProperty(_comments0$comments1$, 'equals', equals), _defineProperty(_comments0$comments1$, 'fmap', fmap), _defineProperty(_comments0$comments1$, 'opM', opM), _defineProperty(_comments0$comments1$, 'e2', e2), _defineProperty(_comments0$comments1$, 'e2x', e2x), _defineProperty(_comments0$comments1$, 'e3', e3), _defineProperty(_comments0$comments1$, 'e4', e4), _defineProperty(_comments0$comments1$, 'e4x', e4x), _defineProperty(_comments0$comments1$, 'e6', e6), _defineProperty(_comments0$comments1$, 'e6x', e6x), _defineProperty(_comments0$comments1$, 'driver', driver), _defineProperty(_comments0$comments1$, 'messages', messages), _defineProperty(_comments0$comments1$, 'monadIt', monadIt), _defineProperty(_comments0$comments1$, 'MonadSet', MonadSet), _defineProperty(_comments0$comments1$, 'updateCalc', updateCalc), _defineProperty(_comments0$comments1$, 'arrayFuncs', arrayFuncs), _defineProperty(_comments0$comments1$, 'nums', nums), _defineProperty(_comments0$comments1$, 'cleanup', cleanup), _defineProperty(_comments0$comments1$, 'ret', ret), _defineProperty(_comments0$comments1$, 'C42', C42), _defineProperty(_comments0$comments1$, 'newTask', newTask), _defineProperty(_comments0$comments1$, 'process', process), _defineProperty(_comments0$comments1$, 'mM$task', mM$task), _defineProperty(_comments0$comments1$, 'colorClick', colorClick), _defineProperty(_comments0$comments1$, 'edit', edit), _defineProperty(_comments0$comments1$, 'testZ', testZ), _defineProperty(_comments0$comments1$, 'quad', quad), _defineProperty(_comments0$comments1$, 'runTest', runTest), _defineProperty(_comments0$comments1$, 'todoStream', todoStream), _defineProperty(_comments0$comments1$, 'inc', inc), _defineProperty(_comments0$comments1$, 'seed', seed), _defineProperty(_comments0$comments1$, 'add', add), _defineProperty(_comments0$comments1$, 'MonadState', MonadState), _defineProperty(_comments0$comments1$, 'primesMonad', primesMonad), _defineProperty(_comments0$comments1$, 'fibsMonad', fibsMonad), _defineProperty(_comments0$comments1$, 'primeFibInterface', primeFibInterface), _defineProperty(_comments0$comments1$, 'tr3', tr3), _defineProperty(_comments0$comments1$, 'fpTransformer', fpTransformer), _defineProperty(_comments0$comments1$, 'factorsMonad', factorsMonad), _defineProperty(_comments0$comments1$, 'factorsInput', factorsInput), _defineProperty(_comments0$comments1$, 'promise', promise), _defineProperty(_comments0$comments1$, 'promiseSnippet', promiseSnippet), _defineProperty(_comments0$comments1$, 'timeout', timeout), _defineProperty(_comments0$comments1$, 'timeoutSnippet', timeoutSnippet), _defineProperty(_comments0$comments1$, 'examples', examples), _defineProperty(_comments0$comments1$, 'examples2', examples2), _comments0$comments1$);
