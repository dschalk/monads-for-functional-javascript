	...
	function main(sources) {
	  ...
	  return {
	    DOM: calcStream$.map(function () {
	      ...
	      (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('h3', 'COMMENTS'), (0, _dom.h)('textarea#comment'), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('div', mMcomments.x), (0, _dom.h)('br'), (0, _dom.h)('br'), (0, _dom.h)('p', ' A comment is added by sending the comment to the server. The server preserves the comment and broadcasts it to all online browsers. This is the server code:'), _code2.default.comments2, (0, _dom.h)('br'),
	      /*   comments2, */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	exports.default = (_comments1$comments2$ = { comments1: comments1, comments2: comments2, todo1: todo1, todo2: todo2, sco: sco, calculations: calculations, prototypeAdditions: prototypeAdditions, styl: styl, num_op: num_op, fetch: fetch, gameMonad_2: gameMonad_2, newRoll: newRoll, primes3: primes3, primes2: primes2, primes: primes, variations: variations, MonadEmitter: MonadEmitter, clicks: clicks, bNode: bNode, MonadState2: MonadState2, gameMonad: gameMonad, cycle: cycle, monad: monad, hardWay: hardWay, hardWay2: hardWay2, async1: async1, async2: async2, execP: execP, workerD$: workerD$, fact_workerC: fact_workerC, fact2_workerD: fact2_workerD, primes_state: primes_state, workerB_Driver: workerB_Driver, workerC: workerC, worker$: worker$, errorDemo: errorDemo, monadEr: monadEr, backAction: backAction, tests: tests, mMZ10: mMZ10, test3: test3 }, _defineProperty(_comments1$comments2$, 'monad', monad), _defineProperty(_comments1$comments2$, 'equals', equals), _defineProperty(_comments1$comments2$, 'fmap', fmap), _defineProperty(_comments1$comments2$, 'opM', opM), _defineProperty(_comments1$comments2$, 'e2', e2), _defineProperty(_comments1$comments2$, 'e2x', e2x), _defineProperty(_comments1$comments2$, 'e3', e3), _defineProperty(_comments1$comments2$, 'e4', e4), _defineProperty(_comments1$comments2$, 'e4x', e4x), _defineProperty(_comments1$comments2$, 'e6', e6), _defineProperty(_comments1$comments2$, 'e6x', e6x), _defineProperty(_comments1$comments2$, 'driver', driver), _defineProperty(_comments1$comments2$, 'messages', messages), _defineProperty(_comments1$comments2$, 'monadIt', monadIt), _defineProperty(_comments1$comments2$, 'MonadSet', MonadSet), _defineProperty(_comments1$comments2$, 'updateCalc', updateCalc), _defineProperty(_comments1$comments2$, 'arrayFuncs', arrayFuncs), _defineProperty(_comments1$comments2$, 'nums', nums), _defineProperty(_comments1$comments2$, 'cleanup', cleanup), _defineProperty(_comments1$comments2$, 'ret', ret), _defineProperty(_comments1$comments2$, 'C42', C42), _defineProperty(_comments1$comments2$, 'newTask', newTask), _defineProperty(_comments1$comments2$, 'process', process), _defineProperty(_comments1$comments2$, 'mM$task', mM$task), _defineProperty(_comments1$comments2$, 'colorClick', colorClick), _defineProperty(_comments1$comments2$, 'edit', edit), _defineProperty(_comments1$comments2$, 'testZ', testZ), _defineProperty(_comments1$comments2$, 'quad', quad), _defineProperty(_comments1$comments2$, 'runTest', runTest), _defineProperty(_comments1$comments2$, 'todoStream', todoStream), _defineProperty(_comments1$comments2$, 'inc', inc), _defineProperty(_comments1$comments2$, 'seed', seed), _defineProperty(_comments1$comments2$, 'add', add), _defineProperty(_comments1$comments2$, 'MonadState', MonadState), _defineProperty(_comments1$comments2$, 'primesMonad', primesMonad), _defineProperty(_comments1$comments2$, 'fibsMonad', fibsMonad), _defineProperty(_comments1$comments2$, 'primeFibInterface', primeFibInterface), _defineProperty(_comments1$comments2$, 'tr3', tr3), _defineProperty(_comments1$comments2$, 'fpTransformer', fpTransformer), _defineProperty(_comments1$comments2$, 'factorsMonad', factorsMonad), _defineProperty(_comments1$comments2$, 'factorsInput', factorsInput), _defineProperty(_comments1$comments2$, 'promise', promise), _defineProperty(_comments1$comments2$, 'promiseSnippet', promiseSnippet), _defineProperty(_comments1$comments2$, 'timeout', timeout), _defineProperty(_comments1$comments2$, 'timeoutSnippet', timeoutSnippet), _defineProperty(_comments1$comments2$, 'examples', examples), _defineProperty(_comments1$comments2$, 'examples2', examples2), _comments1$comments2$);
