...
h('span', ' Next, the undefined variable ox appears halfway through the sequence of computations. What happened and where it happened are immediately apparent in the screenshot. Just look for the first appearance of ' ),h('pre.turk', `MonadMaybe  {id: "Nothing, x: "Nothing"    result.x Nothing  ` ),
h('br' ),    
h('img', {props: {src: "/images/ox.png" }},  ),    
h('p', ' And finally, "cow"/0 causes mQ1.x == NaN. ' ),
